    ...
    for (const oi of order.items) {
      ...
      const si = await prisma.settlementItem.create({
        data: {
          ...
          // PRD v1.1 fields
          productAmount: moneyToString(itemBreakdown.taxIncl),
          commissionAmount: moneyToString(commission),
          commissionRate: oi.platformCommissionRate.toString(),
          cashPaidAmount: moneyToString(itemBreakdown.taxIncl),
          netSettlementAmount: moneyToString(netBreakdown.taxIncl),
          taxIncludedAmount: moneyToString(itemBreakdown.taxIncl),
          taxExcludedAmount: moneyToString(itemBreakdown.taxExcl),
          // Legacy compat
    ...
    case "pending_appreciation": {
      ...
      await prisma.settlementItem.create({
        data: {
          ...
          productAmount: moneyToString(breakdown.taxIncl),
          commissionAmount: moneyToString(commission),
          commissionRate: moneyToString(money(commRate)),
          cashPaidAmount: moneyToString(breakdown.taxIncl),
          netSettlementAmount: moneyToString(netBd.taxIncl),
          taxIncludedAmount: moneyToString(breakdown.taxIncl),
          taxExcludedAmount: moneyToString(breakdown.taxExcl),
      ...
      await LedgerService.createEntry(tx(), {
        ...
        entryType: LedgerEntryType.ORDER_CAPTURED,
    ...
    case "hi_coin_payment": {
      ...
      await prisma.settlementItem.create({
        data: {
          ...
          netAmountTaxExcl: moneyToString(netBd.taxExcl),
          netTaxAmount: moneyToString(netBd.taxAmount),
          platformSubsidyAmount: moneyToString(money(hiCoinUsed)),
          hiCoinRedeemedAmount: moneyToString(money(hiCoinUsed)),
          cashPaidAmount: moneyToString(money(cashPaid)),
          productAmount: moneyToString(breakdown.taxIncl),
