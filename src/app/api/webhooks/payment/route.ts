    ...
    for (const oi of order.items) {
      ...
      await prisma.settlementItem.create({
        data: {
          ...
          // PRD v1.1 fields
          productAmount: moneyToString(itemAmountBreakdown.taxIncl),
          commissionAmount: moneyToString(commissionAmount),
          commissionRate: oi.platformCommissionRate.toString(),
          promotionCostAmount: oi.campaignDiscount.toString(),
          hiCoinRedeemedAmount: oi.hiCoinAmount.toString(),
          cashPaidAmount: oi.cashAmount.toString(),
          netSettlementAmount: moneyToString(netBreakdown.taxIncl),
          taxIncludedAmount: moneyToString(itemAmountBreakdown.taxIncl),
          taxExcludedAmount: moneyToString(itemAmountBreakdown.taxExcl),
          // Legacy compat
